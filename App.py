...
with col2:
    st.image(r"D:/Placement Training/Salary.jpg", caption="Let's predict", use_container_width=True)
...
scaler = joblib.load(r"D:\Placement Training\scaler.pkl")
model = joblib.load(r"D:\Placement Training\model.pkl")
